...
public class EmpController implements Initializable {
	...
	@FXML private TextField findData;
...
//		tf2.setText(emp.first_name);
	...
	public void handle1(ActionEvent event) throws ClassNotFoundException, SQLException {
		...
		Emp emp = ed.find(Integer.parseInt(findData.getText()));
		findData.setText(emp.emp_name);
		findData.setText(emp.emp_salary+"");
		
		//tf2.setInt(emp.emp_salary);
