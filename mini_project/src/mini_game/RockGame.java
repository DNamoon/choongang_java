...
public class RockGame extends ChanceNumber {   //클래스 나누면서 필드 어떻게 하나 했는데 상속으로 해결!
	...
	int rockGame() {
		...
		if(com == 1) { //1을 가위, 2를 바위, 3을 보라고 약속!
			System.out.println("computer는 가위를 냈습니다.");  //컴퓨터가 무엇을 냈는지 알게 쉽게 표시했습니다.
			...
			System.out.println("computer는 바위를 냈습니다.");  //컴퓨터가 무엇을 냈는지 알게 쉽게 표시했습니다.
			...
			System.out.println("computer는 보를 냈습니다.");   //컴퓨터가 무엇을 냈는지 알게 쉽게 표시했습니다.
